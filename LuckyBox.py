...
show_label1 = Label(root, textvariable=var1, justify="center", anchor=CENTER, bg="#FF5252", width=14, height=1,fg="#FCE4EC",
    font="微软雅黑 -30 bold")
show_label1.place(anchor=NW, x=160, y=180)
var2 = StringVar(value="下一个幸运儿会是谁呢")
show_label2 = Label(root, textvariable=var2, justify="center", anchor=CENTER, width=18, height=2, bg="#FF5252",
    font="微软雅黑 -30 bold", foreground="#FCE4EC")
show_label2.place(anchor=NW, x=120, y=260)
